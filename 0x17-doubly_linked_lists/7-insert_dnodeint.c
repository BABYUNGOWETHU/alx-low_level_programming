...
#include "lists.h"
/**
 * create_dnode - creates the new node
 * @n: data of the node
...
/**
 * insert_dnodeint_at_index - inserts the new node at the given position
 * @h: head of the doubly-linked list
 * @idx: index for insertion of the new node
 * @n: data for the new node
 * Return: addr of new node or NULL if error
 */
